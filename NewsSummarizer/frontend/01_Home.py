...
st.write("This Application will summarize news of the previous day for you to read. You can read a random summary in our Tp-News section. If you want to read news of a certain category check ot the category section.")
